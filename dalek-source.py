#this is the result of a bunch of tests while I was learning things in tkinter such as maximizing windows, using images as background and so on, don't take it too serious
